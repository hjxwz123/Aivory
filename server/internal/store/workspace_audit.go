...
const (
	...
	AuditWorkspaceSettingsUpdated    = "workspace.settings_updated"
	AuditWorkspaceDefaultsUpdated    = "workspace.defaults_updated"
	AuditWorkspaceDomainMapped       = "workspace.domain_mapped"
	AuditWorkspaceDomainUnmapped     = "workspace.domain_unmapped"
	AuditWorkspaceConversationViewed = "workspace.conversation_viewed"
)
